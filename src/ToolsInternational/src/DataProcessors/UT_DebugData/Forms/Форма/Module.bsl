...
Procedure ОбновитьТаблицуНаСервере()
	...
	Пока Выборка.Следующий() Цикл
		НоваяСтрока=SavedSettingsTable.Добавить();
	...
	SavedSettingsTable.Сортировать("ДатаСоздания УБЫВ");
EndProcedure
...
Процедура УдалитьНаСервере(ТекущаяСтрока)
	...
	СтрокаТЧ = SavedSettingsTable.НайтиПоИдентификатору(ТекущаяСтрока);

	UT_Common.SystemSettingsStorageDelete(КлючОбъектаНастроек, СтрокаТЧ.КлючНастроек,
